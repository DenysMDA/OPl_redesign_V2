...
const SharedCalling = () => {
    const actions = [
        ...
        { label: "Edit", onClick: () => console.log("Edit clicked!"), disabled: true },
    ];

    const [selectedOption, setSelectedOption] = useState("Disable in All Markets");
        ...
        <div>
            ...
            <div className="radio-button-group-wrapper">
                <div className="radio-button-group">
                    <button
                        className={`radio-button ${selectedOption === "Disable in All Markets" ? "active" : ""}`}
                        onClick={() => handleOptionChange("Disable in All Markets")}
                    >
                        Disable in All Markets
                    </button>
                    <button
                        className={`radio-button ${selectedOption === "Enable in All Markets" ? "active" : ""}`}
                        onClick={() => handleOptionChange("Enable in All Markets")}
                    >
                        Enable in All Markets
                    </button>
                    <button
                        className={`radio-button ${selectedOption === "Disable in Some Markets" ? "active" : ""}`}
