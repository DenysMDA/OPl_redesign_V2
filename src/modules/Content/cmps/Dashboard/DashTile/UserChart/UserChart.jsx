    ...
    datasets: [
      {
        ...
        data: [100, 80, 120, 90, 110], // Добавили значение для пятой недели
      ...
      },
      {
        ...
        data: [70, 100, 50, 110, 95], // Добавили значение для пятой недели
        type: "line",
    ...
    datasets: [
      {
        label: "New Tenants (This Year)",
        data: [
          800, 750, 900, 850, 1000, 950, 1100, 1050, 1200, 1150, 1300, 1250,
        ],
        backgroundColor: "rgba(255, 99, 132, 0.5)",
        borderColor: "rgba(255, 99, 132, 1)",
        borderWidth: 1,
      ...
      {
        label: "New Tenants (Last Year)",
        data: [900, 850, 700, 750, 800, 850, 700, 750, 800, 850, 900, 950],
        type: "line",
        borderColor: "rgba(54, 162, 235, 1)",
        backgroundColor: "rgba(54, 162, 235, 0.5)",
        fill: false,
