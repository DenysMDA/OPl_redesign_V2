...
const announcement = [
    {
        ...
        description: 'Want to refuse Shared Calling? Now you have such an opportunity.',
        backgroundImage: image1,
    },
    {
        title: 'Routing Permissions',
        description: 'Now you can quickly make an emergency call, such as 911 or other emergency numbers, using the device\'s native dialer.',
        backgroundImage: image3,
    },
    {
        title: 'Copilot',
        description: 'New possibilities of artificial intelligence. Now you don\'t have to think how to solve a problem, everything has already been thought for you.',
...
const latestUpdates = [
    {
        ...
        description: 'Еhe application UI/UX will never be the same again. Simplicity, speed and updated interface will change the approach to communication',
        backgroundImage: image5,
    },
    {
        title: 'MSAL',
        description: 'The new authorization and authentication mechanism will further enhance the security level',
            ...
            <div className="dashboard-content">
                ...
                >
                                ...
                                <div className="regions-desc">
                                    ...
                                    <div className="regions">
                                        ...
                                        {remainingCount > 0 && !showAllRegions && (
                                            <span className='show-more' onClick={toggleShowAllRegions}>
                                                {' '}
                                                +{remainingCount}
                                            </span>
                                        )}
                    ...
                    <div key="tenants">
                        <DashTile title="Tenants" footerContent="">
                            <div className="search">
                                ...
                                <input placeholder='Search Tenant' type="text" className="search-input"/>
                            </div>
                    ...
                    <div key="announcement">
                        <DashTile title="Announcement" footerContent="" className='slider-dashboard'>
                            <MySwiper slides={latestUpdates} />
                        </DashTile>
                    </div>
                    <div key="latestUpdates">
                        <DashTile title="Latest Updates" footerContent="" className='slider-dashboard'>
